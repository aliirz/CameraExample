...
- (void)viewDidLoad
{
    ...
    [cameraButton setTitle:@"Camera2" forState:UIControlStateNormal];
    [cameraButton addTarget:self action:@selector(cameraLibraryButtonClick:) forControlEvents:UIControlEventTouchUpInside];
